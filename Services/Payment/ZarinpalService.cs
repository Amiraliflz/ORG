...
=======
      ...
      _logger = logger;
>>>>>>> e877013 (Enhance ZarinpalService with improved logging and configuration validation. Added detailed error handling for payment requests and responses, ensuring robust integration with Zarinpal API.)
