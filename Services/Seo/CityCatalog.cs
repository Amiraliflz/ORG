  ...
  private static readonly Dictionary<string, CityProfile> HandByName =
    new(StringComparer.Ordinal)
    {
      ...
      ["کاشان"] = P("کاشان", "kashan", "مرکز / اصفهان", "توقفگاهی میان تهران و مرکز",
        "کاشان روی کریدور تهران–اصفهان قرار دارد و برای سفرهای کوتاه و میان‌مدت گزینه پرتکرار است.",
      ...
      ["زنجان"] = P("زنجان", "zanjan", "شمال‌غرب", "اتصال به تبریز و اردبیل",
        "زنجان روی کریدور شمال‌غرب قرار دارد و اغلب در مسیرهای طولانی‌تر به‌عنوان گره عبور شناخته می‌شود.",
